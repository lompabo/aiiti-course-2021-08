...
This tutorial in particular deals with a method to enable constrained optimization over complex systems, by approximating their behavior using a Machine Learning model and embedding such model in a declarative optimization formalism. As a case study, we consider an epidemic control problem via Non-Pharmaceutical Interventions.
